        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            <div className="mb-8">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">University Name, 2019 - 2023</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300">Based in City, Country</p>
            </div>

            <div className="mb-8">
              <h3 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Skills</h3>
              <div className="flex flex-wrap gap-2">
                {['React', 'JavaScript', 'Node.js', 'MongoDB', 'HTML', 'CSS', 'Tailwind CSS'].map((skill) => (
                  <span
                    key={skill}
